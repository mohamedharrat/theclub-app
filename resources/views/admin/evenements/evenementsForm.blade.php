            ...
            <div class="card bg bg-dark text-light">
                <div class="card-body">
                    ...
                    <div class="card mb-3 bg bg-dark">
                        ...
                        <input type="number" name="player" id="player" class="bg bg-dark text-light  @error('players_number')is-invalid @enderror">
                ...
                <div class="card-body">
                    ...
                    <div class="card mb-3 bg bg-dark">
                        ...
                        <input class="bg bg-dark text-light  @error('city')is-invalid @enderror" type="text" name="ville" id="ville">
                        @error('city')
                        <div class="alert alert-danger">
                         {{$message}}
                        </div>
